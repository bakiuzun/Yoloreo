...
model.load_pretrained_weights("/share/projects/cicero/checkpoints_baki/weights_7/best.pt")
model.nc = 1
model.names = ["erosion"]
...
for i in range(15,30):
    ...
    print(image_path)
    pred_one_image(model,image_path,mode="validation",output_file=None)
